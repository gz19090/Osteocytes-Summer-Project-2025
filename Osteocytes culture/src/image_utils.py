...
def apply_fourier_filter(image: np.ndarray) -> np.ndarray:
    ...
    filter frequencies, inverse shifts and transforms, and rescales the result.
...
def save_image(image: np.ndarray, output_path: str) -> None:
    ...
    This function saves the image using imageio, ensuring TIFF format for compatibility.
